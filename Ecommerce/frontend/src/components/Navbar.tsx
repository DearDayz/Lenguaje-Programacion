      ...
      <div className="container mx-auto">
        <div className="flex items-center justify-between h-16">
          ...
          <Link to="/" className="flex items-center">
            <span className="text-2xl font-bold text-primary">Disfracasos</span>
          </Link>
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <Link to="/nosotros" className="text-gray-700 hover:text-primary transition-colors">
              Nosotros
            </Link>
            <span 
            ...
            <Link to="/contacto" className="text-gray-700 hover:text-primary transition-colors">
              Contacto
            </Link>
          </div>
                  ...
                  <SheetFooter className="border-t pt-4">
                    <div className="w-full space-y-4">
                      ...
                      <div className="grid grid-cols-2 gap-4">
                        ...
                        <SheetClose asChild>
                          <Button className="w-full hover:bg-primary/90 transition-colors" onClick={handleCheckout}>
                            Finalizar Compra
                          </Button>
                        </SheetClose>
                      </div>
            ...
            <Sheet open={mobileMenuOpen} onOpenChange={setMobileMenuOpen}>
              ...
              <SheetContent side="right" className="w-[250px]">
                ...
                <div className="py-6 flex flex-col space-y-4">
                  ...
                  <SheetClose asChild>
                    <Link to="/nosotros" className="text-lg hover:text-primary transition-colors">
                      Nosotros
                    </Link>
                  </SheetClose>
                  <SheetClose asChild>
