...
const HeroBanner = () => {
  ...
  return (
    <div className="relative h-[80vh] w-full overflow-hidden bg-black">
      <div
        className="absolute inset-0 bg-[url('http://localhost:8080/public/hallow.jpg')] bg-cover bg-center"
      ...
      <div className="relative container h-full flex flex-col justify-center items-start">
        ...
        <p className="animate-fade-in-up text-lg md:text-xl text-white/90 mb-8 max-w-xl">
          Descubre nuestra colección premium de disfraces para cada ocasión.
          Desde superhéroes hasta personajes de fantasía.
        </p>
