    ...
    <div className="container mx-auto py-32">
      ...
      <div className="text-center mb-16">
        ...
        <p className="text-gray-600 max-w-2xl mx-auto">
          Somos Disfracasos, tu destino para disfraces premium y accesorios para
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center mb-20">
        <div>
          ...
          <p className="text-gray-600 mb-4">
            Disfracasos nació en 2010 con una misión clara: hacer que los
            disfraces de alta calidad sean accesibles para todos. Lo que comenzó
            como una pequeña tienda en el centro de la ciudad se ha convertido
            en uno de los principales proveedores de disfraces en todo el país.
          </p>
          <p className="text-gray-600 mb-4">
            Desde nuestros humildes comienzos, nos hemos mantenido fieles a
            nuestros valores fundamentales: calidad, creatividad y atención al
            cliente. Cada disfraz que vendemos pasa por un riguroso control de
            calidad para garantizar que nuestros clientes reciban solo lo mejor.
          </p>
          <p className="text-gray-600">
            Hoy, seguimos creciendo y expandiendo nuestra colección, siempre
            buscando las últimas tendencias y escuchando lo que nuestros
            clientes desean.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <Card className="text-center">
            <CardContent className="pt-6">
              ...
              <p className="text-gray-600">
                Nos comprometemos a ofrecer disfraces durables y de alta calidad
          ...
          <Card className="text-center">
            <CardContent className="pt-6">
              ...
              <p className="text-gray-600">
                Buscamos constantemente diseños innovadores que te ayuden a
                destacar en cualquier evento.
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="text-center">
            <CardContent className="pt-6">
              ...
              <p className="text-gray-600">
                ...
                compra y atención personalizada.
              </p>
            </CardContent>
          </Card>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          <div className="flex items-start space-x-4">
            ...
            <div>
              ...
              <p className="text-gray-600">
                Entregamos tu pedido en tiempo récord para que puedas disfrutar
                de tu disfraz lo antes posible.
              </p>
            </div>
          </div>
          ...
          <div className="flex items-start space-x-4">
            ...
            <div>
              ...
              <p className="text-gray-600">
                Ofrecemos múltiples métodos de pago con la máxima seguridad para
                tus transacciones.
              </p>
            </div>
          </div>
          ...
          <div className="flex items-start space-x-4">
            ...
            <div>
              ...
              <p className="text-gray-600">
                Encuentra disfraces para todas las edades, temas y ocasiones en
          ...
          <div className="flex items-start space-x-4">
            ...
            <div>
              ...
              <p className="text-gray-600">
                Nuestro equipo está disponible para ayudarte a encontrar el
                disfraz perfecto para tu evento.
              </p>
            </div>
          </div>
          ...
          <div className="flex items-start space-x-4">
            ...
            <div>
              ...
              <p className="text-gray-600">
                Si no estás satisfecho con tu compra, trabajaremos contigo para
      ...
      <div className="text-center bg-primary/5 py-12 px-4 rounded-lg">
        <h2 className="text-2xl font-bold mb-4">
          ¿Listo para encontrar tu disfraz perfecto?
        </h2>
        <p className="text-gray-600 max-w-2xl mx-auto mb-6">
          Explora nuestra colección y encuentra el disfraz que hará que tu
          próximo evento sea inolvidable.
        </p>
        <Button asChild>
