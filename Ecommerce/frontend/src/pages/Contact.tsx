    ...
    <div className="container mx-auto py-32">
      ...
      <div className="text-center mb-16">
        ...
        <p className="text-gray-600 max-w-2xl mx-auto">
          Estamos aquí para ayudarte. Contáctanos si tienes alguna pregunta, sugerencia o inquietud.
        </p>
      </div>
            ...
            <Card>
              <CardContent className="p-6 flex items-start space-x-4">
                ...
                <div>
                  ...
                  <a href="mailto:info@costumecove.com" className="text-primary hover:underline">
                    info@costumecove.com
                  </a>
                  <p className="text-gray-600 mt-2 mb-1">Para servicio al cliente:</p>
                  <a href="mailto:support@costumecove.com" className="text-primary hover:underline">
                    support@costumecove.com
                  </a>
                </div>
              </CardContent>
            </Card>
            ...
            <Card>
              <CardContent className="p-6 flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600 mt-2 mb-1">Ventas corporativas:</p>
                  <a href="tel:+123456789" className="text-primary hover:underline">
                    (123) 456-7891
                  </a>
                </div>
              ...
              <CardContent className="p-6 flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-800">
                    Calle Fiesta 123, Colonia Centro<br />
      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="space-y-4">
          <div className="bg-gray-50 p-6 rounded-lg">
            <h3 className="font-bold text-lg mb-2">¿Cuál es el tiempo de entrega?</h3>
            <p className="text-gray-600">
              El tiempo de entrega estándar es de 3-5 días hábiles. Para pedidos urgentes, 
              ofrecemos envío express con entrega en 24-48 horas (consultar costos adicionales).
            </p>
          </div>
          <div className="bg-gray-50 p-6 rounded-lg">
            <h3 className="font-bold text-lg mb-2">¿Puedo devolver un disfraz?</h3>
            <p className="text-gray-600">
              Sí, aceptamos devoluciones dentro de los 30 días posteriores a la compra, 
              siempre que el producto esté en su estado original con todas las etiquetas.
            </p>
          </div>
          <div className="bg-gray-50 p-6 rounded-lg">
            <h3 className="font-bold text-lg mb-2">¿Ofrecen disfraces personalizados?</h3>
            <p className="text-gray-600">
              Sí, ofrecemos servicios de personalización para eventos especiales, 
              producciones teatrales y grupos grandes. Contáctanos para más información.
            </p>
          </div>
        </div>
      </div>
